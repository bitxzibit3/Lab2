...
template<class T>
Polynom<T> *Polynom<T>::operator+(Polynom<T> *other) {
    return PolynomSum(this, other);
}

template<class T>
Polynom<T> *Polynom<T>::operator*(Polynom<T> *other) {
    return PolynomMult(this, other);
}

template<class T>
Polynom<T> *Polynom<T>::operator^(size_t deg) {
    return PolynomDegree(this, deg);
}

template<class T>
Polynom<T> *Polynom<T>::operator|(Polynom<T> *other) {
    return PolynomComp(this, other);
}

template<class T>
T Polynom<T>::operator()(T x) {
...
{
    this->data->Insert(value, index, checker);
}
